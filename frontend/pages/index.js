        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="rounded-2xl bg-brand-50 p-7 lg:col-span-4">
            ...
            <div className="mt-5 space-y-3">
              <div className="rounded-xl bg-white p-3.5 text-[13px] leading-snug text-ink-700 shadow-sm">
                💬 Give me a list of my appointments from this week
              </div>
              <div className="rounded-xl bg-white p-3.5 text-[13px] leading-snug text-ink-700 shadow-sm">
                💬 How can I book a service at your business?
              </div>
            </div>
          </div>

          {/* Fast & Smooth Response — tall card, illustration placeholder */}
          <div className="flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white p-7 lg:col-span-3 lg:row-span-2">
            <h3 className="text-xl font-bold text-ink-900">Fast &amp; Smooth Response</h3>
            <div className="mt-5 flex flex-1 items-end">
              <div className="flex h-44 w-full items-center justify-center rounded-xl border-2 border-dashed border-brand-200 bg-brand-50/60 p-4 text-center text-sm text-ink-400">
          ...
          <div className="rounded-2xl bg-brand-100 p-7 lg:col-span-4">
            ...
            <p className="mt-3 text-[13px] leading-snug text-ink-700">
              Every answer is clear, structured and backed by your own knowledge base.
            </p>
          </div>
        </div>
      </div>
...
function Hero() {
  return (
    <section id="hero" className="relative overflow-hidden bg-white">
      {/* Soft green circle behind the illustration */}
      <div
        aria-hidden="true"
        className="absolute -right-48 top-1/2 hidden h-[620px] w-[620px] -translate-y-1/2 rounded-full bg-brand-50 lg:block"
      />

      <div className="relative mx-auto grid max-w-6xl items-center gap-14 px-6 pb-20 pt-14 sm:pt-20 lg:grid-cols-2 lg:gap-8">
        ...
        <div className="relative flex items-center justify-center py-6 lg:py-0">
          ...
          />
          <div className="relative flex h-72 w-72 items-center justify-center rounded-3xl border-2 border-dashed border-brand-300 bg-white/70 text-center sm:h-96 sm:w-96">
            <span className="text-sm text-ink-400">
              Image placeholder
              <br />
              (add your image here)
...
const CTA_CARDS = [
  {
    ...
    body: 'We believe in the power of teamwork, where diverse perspectives merge to fuel creativity and drive progress.',
  },
  {
    icon: '📄',
    bg: 'bg-brand-50',
    title: 'Actionable Insights',
    body: 'Through advanced analytics & cutting-edge technology, we uncover valuable patterns, trends, and opportunities.',
  },
  {
    icon: '💡',
    bg: 'bg-brand-100',
    title: 'Efficiency & Accuracy',
    body: 'We prioritize streamlining processes & leveraging the latest technologies to ensure maximum productivity & precision.',
  },
];
  ...
  return (
    <>
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-center text-3xl font-bold tracking-tight text-ink-900 sm:text-4xl">
            The Leading AI Assistant for Your Business
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-center text-sm leading-relaxed text-ink-500">
            OneWayChat is a leading conversational AI assistant for businesses. Try our
            application today to get assistance on your ongoing projects &amp; tasks.
          </p>
